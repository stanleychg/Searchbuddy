 ...
 */
package com.buddy.tesseract;

import com.buddy.search.MyService;
import com.buddy.search.R;
...
public class PreferencesActivity extends PreferenceActivity implements
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
    ...
    if (key.equals(KEY_TRANSLATOR)) {
      listPreferenceTranslator.setSummary(sharedPreferences.getString(key, MyService.DEFAULT_TRANSLATOR));
    } else if(key.equals(KEY_SOURCE_LANGUAGE_PREFERENCE)) {
      
      // Set the summary text for the source language name
      listPreferenceSourceLanguage.setSummary(LanguageCodeHelper.getOcrLanguageName(getBaseContext(), sharedPreferences.getString(key, MyService.DEFAULT_SOURCE_LANGUAGE_CODE)));
      ...
      listPreferenceTargetLanguage.setSummary(LanguageCodeHelper.getTranslationLanguageName(this, sharedPreferences.getString(key, MyService.DEFAULT_TARGET_LANGUAGE_CODE)));
    } else if (key.equals(KEY_PAGE_SEGMENTATION_MODE)) {
      listPreferencePageSegmentationMode.setSummary(sharedPreferences.getString(key, MyService.DEFAULT_PAGE_SEGMENTATION_MODE));
    } else if (key.equals(KEY_OCR_ENGINE_MODE)) {
      listPreferenceOcrEngineMode.setSummary(sharedPreferences.getString(key, MyService.DEFAULT_OCR_ENGINE_MODE));
  ...
  void initTranslationTargetList() {
    ...
    String currentLanguageCode = sharedPreferences.getString(KEY_TARGET_LANGUAGE_PREFERENCE, 
        MyService.DEFAULT_TARGET_LANGUAGE_CODE);
    ...
    String translator = sharedPreferences.getString(KEY_TRANSLATOR, MyService.DEFAULT_TRANSLATOR);
...
//      newLanguageCode = TranslatorGoogle.toLanguage(currentLanguage);
  ...
  protected void onResume() {
    ...
    listPreferenceTranslator.setSummary(sharedPreferences.getString(KEY_TRANSLATOR, MyService.DEFAULT_TRANSLATOR));
    listPreferenceSourceLanguage.setSummary(LanguageCodeHelper.getOcrLanguageName(getBaseContext(), sharedPreferences.getString(KEY_SOURCE_LANGUAGE_PREFERENCE, MyService.DEFAULT_SOURCE_LANGUAGE_CODE)));
    listPreferenceTargetLanguage.setSummary(LanguageCodeHelper.getTranslationLanguageName(getBaseContext(), sharedPreferences.getString(KEY_TARGET_LANGUAGE_PREFERENCE, MyService.DEFAULT_TARGET_LANGUAGE_CODE)));
    listPreferencePageSegmentationMode.setSummary(sharedPreferences.getString(KEY_PAGE_SEGMENTATION_MODE, MyService.DEFAULT_PAGE_SEGMENTATION_MODE));
    listPreferenceOcrEngineMode.setSummary(sharedPreferences.getString(KEY_OCR_ENGINE_MODE, MyService.DEFAULT_OCR_ENGINE_MODE));
